...
2. _X_ Make a new GitHub repository called liri-node-app and clone it to your computer.
...
2. _X_Make a .gitignore file and add the following lines to it. This will tell git not to track these files, and thus they won't be committed to Github.
...
3. _X_Make a JavaScript file named `keys.js`.
...
8. _X_At the top of the `liri.js` file, add code to read and set any environment variables with the dotenv package:
